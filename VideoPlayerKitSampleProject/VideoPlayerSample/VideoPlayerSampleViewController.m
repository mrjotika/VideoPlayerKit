...
- (void)playVideo
{
    ...
    AVURLAsset *asset = [AVURLAsset assetWithURL:self.address];
    [self.videoPlayerViewController playVideoWithTitle:@"Title" asset:asset videoID:nil shareURL:nil isStreaming:NO playInFullScreen:YES];
}
